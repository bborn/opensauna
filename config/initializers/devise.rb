...
Devise.setup do |config|
  ...
  if ENV['FACEBOOK_APP_ID']
    config.omniauth :facebook, ENV['FACEBOOK_APP_ID'], ENV['FACEBOOK_APP_SECRET'],
      {:scope => 'manage_pages,read_stream,email,publish_stream,offline_access', :client_options => {:ssl => {:ca_file => '/usr/lib/ssl/certs/ca-certificates.crt'}}}
  end
